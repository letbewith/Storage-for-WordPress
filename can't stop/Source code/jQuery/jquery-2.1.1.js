...
// undefined可以被重写 undefined="now it's defined"
// noGlobal 大约是局部的 this

// 列出 源生的方法 不存在会对原本的 方法会造成 干扰这个问题
// 这里只是调用
var arr = [];
...
var
    ...
    // 使用 jQuery的时候 不需要new 在内部已经 new
   //  为什么jQuery要返回jQuery.fn.init对象?
    /**
     * 貌似jQuery 所有 fn 都扔在 .fn.init() 里面了
     * @param selector
     * @param context
     * @returns {Tween.init}
     */
	...
	rmsPrefix = /^-ms-/, //css的前缀,判断ie
	rdashAlpha = /-([\da-z])/gi,

	// Used by jQuery.camelCase as callback to replace() 字符串转换为大写
...
var i,
  ...
  //http://m18701641797.blog.163.com/blog/static/216184008201371310473132/
	...
	// Regular expressions
	// Whitespace characters http://www.w3.org/TR/css3-selectors/#whitespace css3中空白符
    // todo css3 有什么空白符?
    // \x20：空格;\t水平制表符(tab);\r\n回车换行\f换页符
	whitespace = "[\\x20\\t\\r\\n\\f]",
